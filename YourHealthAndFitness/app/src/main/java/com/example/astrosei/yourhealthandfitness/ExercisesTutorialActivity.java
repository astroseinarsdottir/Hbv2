...
public class ExercisesTutorialActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exercises_tutorial);
        ...
        getSupportActionBar().setTitle("Exercise Tutorial");
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId()){
                    case R.id.home_id:
                        ...
                        intent = new Intent(ExercisesTutorialActivity.this, HomePageActivity.class);
