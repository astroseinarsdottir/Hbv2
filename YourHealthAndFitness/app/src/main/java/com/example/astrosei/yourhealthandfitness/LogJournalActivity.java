...
public class LogJournalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Log journal");
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId()){
                    case R.id.home_id:
                        ...
                        intent = new Intent(LogJournalActivity.this, HomePageActivity.class);
                    ...
                    case R.id.logout_id:
                        ...
                        session.logoutUser();
                        intent = new Intent(LogJournalActivity.this, IndexActivity.class);
                        startActivity(intent);
                        item.setChecked(true);
                        drawerLayout.closeDrawers();
                        break;
