...
public class UpdateExerciseNetworker {
    ...
    private UpdateExerciseNetworker.getCurrentCycleCallBackForProgram updateExerciseActivity;

    public UpdateExerciseNetworker(Activity activity){
        updateExerciseActivity = (UpdateExerciseNetworker.getCurrentCycleCallBackForProgram)activity;
        ...
        JsonArrayRequest req = new JsonArrayRequest("http://130.208.151.228:8181/mobile_currentCycle?username="+username,
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        updateExerciseActivity.initTableData(cycleArray, date);
